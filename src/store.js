...
export function getTransactions(dispatch, hideLoader, userId=1) {
...
export function deleteTransactions(dispatch, toBeDeleted) {
  axios.delete(`${REACT_APP_BACKEND_URL}/deletetransactions`, {data: toBeDeleted})
    .then((res) => {
